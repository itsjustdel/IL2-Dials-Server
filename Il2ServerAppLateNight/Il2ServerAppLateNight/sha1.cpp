...
Modified to return raw hex digest
-- Trapper McFerron <trapper@trapzz.com>
*/
...
/*
* Add padding and return the raw digest.
*/

const unsigned char* SHA1::final()
{
	...
	static unsigned char r[sizeof(digest)];
	memcpy(r, digest, sizeof(digest));
